...
- [Code Credits](#code-credits)
  - [Similar Student Projects](#similar-student-projects)
...
- 30 Seconds of Code [Scroll Progress Bar](https://www.30secondsofcode.org/css/s/scroll-progress-bar/)
...
- Kenny DuMez - Medium [Understanding the "Your branch is ahead of 'origin/main' by 1 commit" message in Git](https://graphite.dev/guides/understanding-your-branch-is-ahead-of-origin-main-by-1-commit)
- Radu [How to Make Footer Stay at Bottom of Page with Bootstrap](https://radu.link/make-footer-stay-bottom-page-bootstrap/)
- Real Favicon Generator [Favicon Generrator](https://realfavicongenerator.net/)
- Sakshi Rathore - Medium [Git Error: You have divergent branches and need to specify how to reconcile them](https://medium.com/@rajlaxmii/git-error-you-have-divergent-branches-and-need-to-specify-how-to-reconcile-them-75e97bd8abd2)
- Sarah Hudaib [Context Processor in Django](https://dev.to/sarahhudaib/context-processors-in-django-15h2)
- W3Schools [How To - Scroll Back To Top Button](https://www.w3schools.com/howto/howto_js_scroll_to_top.asp)

### Similar Student Projects

Though no specific code has been used from any of these projects and thus they could be listed within [Additional Research](documentation/research.md), I found them incredibly useful for my understanding and wish to include them here.

- Amy Richardson [FreeFido](https://github.com/amylour/FreeFido_v2/tree/main)
- Mark Briscoe [Broken Lines](https://github.com/mbriscoe/broken-lines-blog)
- Sharon (Mayo) Simpson [Lens Whisperer](https://github.com/shar-nm/lens-whisperer/tree/main)
